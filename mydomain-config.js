...
var config = {
    ...
    hosts: {
        ...
        muc: 'conference.' + subdomain + 'mydomain',
    },

    // BOSH URL. FIXME: use XEP-0156 to discover it.
    bosh: 'https://mydomain/' + subdir + 'http-bind',

    // Websocket URL
    // websocket: 'wss://mydomain/' + subdir + 'xmpp-websocket',

    // The real JID of focus participant - can be overridden here
    // Do not change username - FIXME: Make focus username configurable
    // https://github.com/jitsi/jitsi-meet/issues/7376
    // focusUserJid: 'focus@auth.mydomain',
    ...
    //     // by default uses:
    //     // 'https://mydomain/static/oauth.html'
    //     redirectURI:
    //          'https://mydomain/subfolder/static/oauth.html',
    // },
    ...
    defaultRemoteDisplayName: 'Patate',
    ...
    // the  stats) as it is done in the jitsi-meet-torture bandwidth
    // estimation tests.
    // gatherStats: false,
    ...
    p2p: {
        ...
        // the  standard:
        // https://www.w3.org/TR//#rtcicetransportpolicy-enum.
...
//    deeplinking: {
  ...
  //       disabled: true,
    ...
    */
    // dynamicBrandingUrl: 'https://mydomain/remoteconfig',
    ...
    // moderatedRoomServiceUrl: 'https://moderated.mydomain',
    ...
    */
    ...
    //     // (width, tiles aspect ratios) through the interafaceConfig options.
